        ...
        <div className="max-w-2xl">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            <button
              ...
              className="group inline-flex items-center gap-2 rounded-full bg-lime-500 px-5 py-2.5 text-sm font-semibold text-charcoal-950 transition-all hover:-translate-y-0.5 hover:bg-lime-400 hover:shadow-[0_0_0_1px_var(--color-lime-400),0_8px_30px_-8px_color-mix(in_oklab,var(--color-lime-500)_55%,transparent)]"
            >
